...
- The bit labeled ``I`` (``1``) is the length type I, which indicates that the length is a 11-bit number representing the number of sub-packets.
...
- ``C200B40A82`` finds the sum of ``1`` and ``2``, resulting in the value <b><code>3</code>.</b>
- ``04005AC33890`` finds the product of ``6`` and ``9``, resulting in the value <b><code>54</code>.</b>
- ``880086C3E88112`` finds the minimum of ``7``, ``8``, and ``9``, resulting in the value <b><code>7</code>.</b>
- ``CE00C43D881120`` finds the maximum of ``7``, ``8``, and ``9``, resulting in the value <b><code>9</code>.</b>
